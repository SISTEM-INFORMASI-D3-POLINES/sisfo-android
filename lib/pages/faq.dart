...
class _FreqAQState extends State<FreqAQ> {
  List<Question> questions = [
    ...
    Question(tanya: 'Saya lupa Password, bagaimana cara untuk mereset password?', jawab: 'Silahkan reset password Anda dengan menghubungi admin melalui admin@email.com atau dengan mendatangi Unit Pelayanan Terpadu Teknologi Informasi dan Komunikasi Politeknik Negeri Semarang. Informasi ini juga terdapat pada antarmuka Login pada "Lupa Password".'),
